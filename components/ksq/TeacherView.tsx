...
export default function TeacherView() {
  ...
  const [subject, Subject] = useState("Riyaziyyat");
    ...
    <div style={{ maxWidth: 800, margin: "0 auto", paddingBottom: 50 }}>
      <div style={{ marginBottom: 28 }}>
        <h1 style={{ fontSize: 24, fontWeight: 800, color: COLORS.ink, margin: 0 }}>
          Müəllim İmtahan Paneli (Bulud)
        </h1>
        <p style={{ fontSize: 14, color: COLORS.inkSoft, marginTop: 6 }}>
          Buradan yaratdığınız testlər birbaşa mərkəzi bazaya yazılır və şagirdlər tərəfindən dərhal görünür.
        </p>
      </div>
